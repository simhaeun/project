...
window.onload = function(){
    imgWrap.forEach((el, i) => {
        ...
        if(window.pageYOffset >= 0 && window.pageYOffset < (innerHeight * 0.5)){
            h = window.pageYOffset + innerHeight;
        } else {
            h = window.pageYOffset - (innerHeight * 0.5);
        }
...
function imgEvent(){
    ...
    let scrollPer = (pageYOffset / totalHeight) * 500;
